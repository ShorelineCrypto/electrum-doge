...
dogecoin_header_19204 = '01000100f65a247291f5ee322a1ff3f22c3fdb0f60d15707a9842db5e0fa332f5dd8d6071d7bc906ea494a8aa32fdde281fe26a84befefaddaf0dcd41dd2da3053bcd5450635904e69b2001b29f30bc9'

dogecoin_header_19414 = ''
dogecoin_prev_hash_19414 = '8b979e3b34faa5ab90a44dcc9a7ab9618640d5d1eec3e8239108c85c6bf80061'
dogecoin_target_19414 = 0xb269000000000000000000000000000000000000000000000000

dogecoin_header_37174 = ''
dogecoin_prev_hash_37174 = '8adc6de6bd46c73aa631a72b29e21e84e49a06ce99002a77dce0b5aca4bf81d6'
dogecoin_target_37174 = 0x242a4a0000000000000000000000000000000000000000000000
...
class Test_auxpow(SequentialTestCase):
    ...
    # Deserialize the AuxPoW header from Dogecoin block #37,174.
    ...
    def test_deserialize_auxpow_header_explicit_coinbase(self):
        header = self.deserialize_with_auxpow(dogecoin_header_37174)
    ...
    def test_deserialize_should_reject_trailing_junk(self):
        with self.assertRaises(Exception):
            self.deserialize_with_auxpow(dogecoin_header_37174 + "00")

    def test_deserialize_with_expected_trailing_data(self):
        data = "00" + dogecoin_header_37174 + "00"
        _, start_position = self.deserialize_with_auxpow(data, expect_trailing_data=True, start_position=1)
        self.assertEqual(start_position, len(dogecoin_header_37174)//2 + 1)

    # Verify the AuxPoW header from Dogecoin block #37,174.
    # Equivalent to checkAuxPoWHeader in libdohj tests.
    def test_verify_auxpow_header_explicit_coinbase(self):
        header = self.deserialize_with_auxpow(dogecoin_header_37174)
        blockchain.Blockchain.verify_header(header, dogecoin_prev_hash_37174, dogecoin_target_37174)

    # Verify the AuxPoW header from Dogecoin block #19,414.  This header
    ...
    def test_verify_auxpow_header_implicit_coinbase(self):
        header = self.deserialize_with_auxpow(dogecoin_header_19414)
        blockchain.Blockchain.verify_header(header, dogecoin_prev_hash_19414, dogecoin_target_19414)
    ...
    def test_should_reject_own_chain_id(self):
        parent_header = self.deserialize_with_auxpow(dogecoin_header_19204)
    ...
    # parser).  We use this Dogecoin header because it has an explicit MM
